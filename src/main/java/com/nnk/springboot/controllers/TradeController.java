...
public class TradeController {
    ...
    public String validate(@Validated @ModelAttribute("trade") Trade trade, BindingResult result, Model model) {
    ...
    public String updateTrade(@PathVariable("id") Integer id, @Validated @ModelAttribute("trade") Trade trade, BindingResult result, Model model) {
        if (result.hasErrors() || !trade.isValid()) {
